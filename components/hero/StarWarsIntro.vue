...
Customised by 
Author: Pierre Davis
Author URI: https://www.coffee.gives/
Description: Adapted the CSS to go full screen when used as a component in an application. 
*/

.star-wars-intro {
  background: url("~/assets/img/stars-bg.jpg") center center;
  height: 100%;
  min-height: 100vh;
  margin: 0px;

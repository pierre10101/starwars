...
onMounted(() => {
    displayFilm.value = films.value.find((film) => film?.episode_id == route.query.id);
})
</script>
                ...
                <div class="w-full md:w-1/2 lg:w-2/3 p-6 self-center">
                    <div class="max-w-lg mx-auto">
                        ...
                        <div class="flex flex-wrap items-center">
                            <p class="font-bold font-heading text-gray-800"><span
                                    class="text-ms italic text-gray-500">Producer -</span> {{ displayFilm?.producer }}</p>
